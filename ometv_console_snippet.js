let apiKey = "d0e691e128cd4210b652e8cb96310a6f";
...
async function getLocation(ip) {
    ...
    try {
        ...
        const html = `
            ...
            Coords: ${data.latitude}, ${data.longitude} <span onclick="navigator.clipboard.writeText('${data.latitude}, ${data.longitude}'); this.innerText='✓'; setTimeout(()=>this.innerText='📋', 1200);" style="cursor:pointer; font-size:12px; margin-left:4px;" title="Copy">📋</span><br><br>
